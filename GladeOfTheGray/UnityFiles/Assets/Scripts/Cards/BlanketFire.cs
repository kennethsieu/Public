...
public class BlanketFire : Card
{
    ...
    public void cardAction(GameObject position)
    {
        ...
        if(enemy1.getCurHealth() != 0)
        {
            ...
            damage.Add(enemy1.decreaseHealth(hero.getAttackDamage() / 2, hero.getBaseCrit()));
        }
        ...
        if(enemy2.getCurHealth() != 0)
        {
            ...
            damage.Add(enemy2.decreaseHealth(hero.getAttackDamage() / 2, hero.getBaseCrit()));
        ...
        if(enemy3.getCurHealth() != 0)
        {
            ...
            damage.Add(enemy3.decreaseHealth(hero.getAttackDamage() / 2, hero.getBaseCrit()));
        }
